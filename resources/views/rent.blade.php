...
<head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-lg-12 short-image-title">
                    <h1 class="second-color">Rent Property</h1>
    ...
    <section class="container">
        <div class="row">
			<div class="row contact1">
				...
				<div class="col-xs-12 col-md-6 margin-top-45" style="background-color: peachpuff;">
					<p class="rentSuccessMsg" style="margin-top: 20px;"></p>
					<h3 style="margin-top: 20px;">Rent Out</h3>
					<form action="" id="ajax-buy-form">
						<div class="row">
							<div class="form-group col-xl-4">
								<label>Name</label>
								<input type="text" class="form-control" name="name" >
								<input type="hidden" class="form-control" name="form" value='form1'>
						...
						<div class="row">
							...
							<div class="form-group col-xl-6">
								...
								<select class="form-control" name="decison" >
						...
						<div class="form-group-btn form-group-btn-placeholder-gap">
							<input type="submit" name="rent_out" class="btn btn-primary btn-block" value="Submit">
						</div><!-- /.form-group -->
					</form>
				</div>
				<div class="col-xs-12 col-md-6 margin-top-45" style="background-color: beige;">
					<p class="rentSuccessMsg1" style="margin-top: 20px;"></p>
					<h3 style="margin-top: 20px;">Rent In</h3>
					<form action="" id="ajax-buy-form1">
						<div class="row">
							<div class="form-group col-xl-4">
								<label>Name</label>
								<input type="text" class="form-control" name="name" >
								<input type="hidden" class="form-control" name="form" value='form2'>
								<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
							</div><!-- /.form-group -->
							<div class="form-group col-xl-4">
								<label>Contact No. </label>
						...
						<br/>
						<div class="form-group-btn form-group-btn-placeholder-gap">
							<input type="submit" name="rent_in" class="btn btn-primary btn-block" value="Submit">
						</div><!-- /.form-group -->
					</form>
	...
	<script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
						...
						if(success =='<h5 style="color:green;">Mail Sent Successfully</h5>'){	
							$('.rentSuccessMsg').html(success);
							$(".rentSuccessMsg").delay(5000).fadeOut('slow');
							window.setTimeout(function(){window.location.reload()}, 10000);
						}	
						if(error !=""){
							$('.rentSuccessMsg').html(error);							
						}
                    }
                });
                return false;
		...
		jQuery(document).ready(function($) {
            $("#ajax-buy-form1").submit(function() {
				/*if($("input[name=name]").val()=='') {
					alert("Name is requred");
					return false;
				}
                ...
                $.ajax({
                    ...
                    success: function(response) {
						...
						//alert(error);	
						if(success =='<h5 style="color:green;">Mail Sent Successfully</h5>'){	
							$('.rentSuccessMsg1').html(success);
							$(".rentSuccessMsg1").delay(5000).fadeOut('slow');
							window.setTimeout(function(){window.location.reload()}, 10000);
						}	
						if(error !=""){
							$('.rentSuccessMsg1').html(error);							
						}
                    }
                });
                return false;
