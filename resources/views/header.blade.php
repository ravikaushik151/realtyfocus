          ...
          <div class="row">
            <div class="col-xs-5 col-sm-8">
              ...
              <div class="top-phone pull-left hidden-xxs">
                ...
                <span class="top-bar-text for-phone"></span>
              </div>
            ...
            <div class="col-xs-7 col-sm-4">
              ...
              <div class="top-social pull-right">
                <a class="top-icon-circle" href="https://www.facebook.com/My-Landmark-1665733157046465">
        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <a href="{{ url('/')}}" title="" class="navbar-brand">
              <img src="{{ asset('public/images/logo-light.png')}}" id="mlogo"
