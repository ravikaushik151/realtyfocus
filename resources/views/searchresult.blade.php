		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-lg-12 short-image-title">
					...
					<h1 class="second-color">Search Result</h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="col-xs-12 col-lg-6">
							...
							<h1>Search <span class="special-color">Result</span></h1>
						</div>
						<div class="col-xs-12 col-lg-6">
				...
				<div class="row grid-offer-row defult">
					...
					while ($i < $addresss){
					@endphp
					@foreach($address[$i]  as $a => $querys)
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 grid-offer-col">
						<div class="grid-offer">
							<div class="grid-offer-front">
								<div class="grid-offer-photo">
									<img class="lazy"
										data-src="http://www.mylandmark.info/admin/images/fimage/{{ $querys->featured_image }}" alt=""  style='height:165px'/>
